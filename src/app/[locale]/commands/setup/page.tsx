...
const SLUG = "setup" as const;
const PATH = "/commands/setup";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/setup">): Promise<Metadata> {
...
export default async function SetupCommandDoc({
  params,
}: PageProps<"/[locale]/commands/setup">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
