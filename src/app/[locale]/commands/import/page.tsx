...
const SLUG = "import" as const;
const PATH = "/commands/import";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/import">): Promise<Metadata> {
...
export default async function ImportCommandDoc({
  params,
}: PageProps<"/[locale]/commands/import">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
