...
const SLUG = "contribute" as const;
const PATH = "/commands/contribute";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/contribute">): Promise<Metadata> {
...
export default async function ContributeCommandDoc({
  params,
}: PageProps<"/[locale]/commands/contribute">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
