...
const SLUG = "pin" as const;
const PATH = "/commands/pin";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/pin">): Promise<Metadata> {
...
export default async function PinCommandDoc({
  params,
}: PageProps<"/[locale]/commands/pin">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
