...
const SLUG = "export" as const;
const PATH = "/commands/export";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/export">): Promise<Metadata> {
...
export default async function ExportCommandDoc({
  params,
}: PageProps<"/[locale]/commands/export">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
