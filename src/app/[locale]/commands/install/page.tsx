...
const SLUG = "install" as const;
const PATH = "/commands/install";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/install">): Promise<Metadata> {
...
export default async function InstallCommandDoc({
  params,
}: PageProps<"/[locale]/commands/install">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
