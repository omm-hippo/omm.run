...
const SLUG = "engine" as const;
const PATH = "/commands/engine";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/engine">): Promise<Metadata> {
...
export default async function EngineCommandDoc({
  params,
}: PageProps<"/[locale]/commands/engine">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
