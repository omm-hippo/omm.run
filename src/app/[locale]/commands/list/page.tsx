...
const SLUG = "list" as const;
const PATH = "/commands/list";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/list">): Promise<Metadata> {
...
export default async function ListCommandDoc({
  params,
}: PageProps<"/[locale]/commands/list">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
