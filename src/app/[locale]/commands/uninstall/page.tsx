...
const SLUG = "uninstall" as const;
const PATH = "/commands/uninstall";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/uninstall">): Promise<Metadata> {
...
export default async function UninstallCommandDoc({
  params,
}: PageProps<"/[locale]/commands/uninstall">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
