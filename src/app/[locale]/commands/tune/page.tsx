...
const SLUG = "tune" as const;
const PATH = "/commands/tune";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/tune">): Promise<Metadata> {
...
export default async function TuneCommandDoc({
  params,
}: PageProps<"/[locale]/commands/tune">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
