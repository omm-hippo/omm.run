...
const SLUG = "help" as const;
const PATH = "/commands/help";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/help">): Promise<Metadata> {
...
export default async function HelpCommandDoc({
  params,
}: PageProps<"/[locale]/commands/help">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
