...
const SLUG = "rollback" as const;
const PATH = "/commands/rollback";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/rollback">): Promise<Metadata> {
...
export default async function RollbackCommandDoc({
  params,
}: PageProps<"/[locale]/commands/rollback">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
