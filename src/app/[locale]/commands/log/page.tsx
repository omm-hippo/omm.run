...
const SLUG = "log" as const;
const PATH = "/commands/log";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/log">): Promise<Metadata> {
...
export default async function LogCommandDoc({
  params,
}: PageProps<"/[locale]/commands/log">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
