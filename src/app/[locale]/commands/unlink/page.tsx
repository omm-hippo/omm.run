...
const SLUG = "unlink" as const;
const PATH = "/commands/unlink";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/unlink">): Promise<Metadata> {
...
export default async function UnlinkCommandDoc({
  params,
}: PageProps<"/[locale]/commands/unlink">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
