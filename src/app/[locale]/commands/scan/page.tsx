...
const SLUG = "scan" as const;
const PATH = "/commands/scan";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/scan">): Promise<Metadata> {
...
export default async function ScanCommandDoc({
  params,
}: PageProps<"/[locale]/commands/scan">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
