...
const SLUG = "upgrade" as const;
const PATH = "/commands/upgrade";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/upgrade">): Promise<Metadata> {
...
export default async function UpgradeCommandDoc({
  params,
}: PageProps<"/[locale]/commands/upgrade">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
