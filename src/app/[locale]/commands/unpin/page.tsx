...
const SLUG = "unpin" as const;
const PATH = "/commands/unpin";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/unpin">): Promise<Metadata> {
...
export default async function UnpinCommandDoc({
  params,
}: PageProps<"/[locale]/commands/unpin">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
