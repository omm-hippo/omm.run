...
const SLUG = "doctor" as const;
const PATH = "/commands/doctor";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/doctor">): Promise<Metadata> {
...
export default async function DoctorCommandDoc({
  params,
}: PageProps<"/[locale]/commands/doctor">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
