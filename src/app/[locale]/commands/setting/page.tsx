...
const SLUG = "setting" as const;
const PATH = "/commands/setting";

export async function generateMetadata({
  params,
}: PageProps<"/[locale]/commands/setting">): Promise<Metadata> {
...
export default async function SettingCommandDoc({
  params,
}: PageProps<"/[locale]/commands/setting">) {
  const { locale } = await params;
  if (!isLocale(locale)) notFound();
